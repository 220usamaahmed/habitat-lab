...
from habitat_baselines.rl.transformer_policy.dataset import RollingDataset
...
class TransformerTrainer(BaseRLTrainer):
    ...
    def __init__(self, config=None):
        ...
        # greater than 1
        self._is_distributed = False #get_distrib_size()[2] > 1
    ...
    def _run_epoch(self, split: str, epoch_num: int = 0):
        ...
        for it, (x, y, r, t) in pbar:
            ...
            print("skill shape == " ,x['joint'].shape) 
            print("x == " , x['skill'][0])
            print("y == ", y[0])
            print("r == " , r[0])
            print("t == " , t[0])
